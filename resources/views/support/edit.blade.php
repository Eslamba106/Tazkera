<x-user.dashboard-layout title="تعديل التذكرة : {{ $item->subject }}">
    <x-slot:breadcrumb >
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">تعديل تذكرة</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="modal-title f-w-600" id="exampleModalLabel">تعديل التذكرة</h5>
                        </div>

                        <div class="card-body">
                            <div class="digital-add needs-validation">
                                <form action="{{ route('user.dashboard.update' , $item->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="validationCustom01" type="text" name="subject" value="{{ old('subject' , $item->subject) }}" >
                                    </div>
                                    <div class="form-group">
                                        <label for="validationCustom01" class="mb-1">الرسالة</label>
                                        <textarea name="message" value="{{ old('message' , $item->message)  }}" class="form-control" id="validationCustom01" cols="30" rows="10"> {{  old('message' , $item->message)  }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="validationCustom01" class="mb-1">درجة الاهمية</label>
                                        <input class="form-control" id="validationCustom01" type="text" name="important_degree" value="{{ old('important_degree' , $item->important_degree)  }}">
                                    </div>
                                    <div class="form-group">
